...
@parent
    ...
    <div class="admin-main layui-anim layui-anim-upbit">
        ...
        <div class="search">
            ...
            <a href="{{url('admin/CarBrand/index')}}" class="layui-btn">重置</a>
            {{--<a href="{{url('admin/CarBrand/add')}}"class="layui-btn" style="float:right;">添加信息</a>--}}
    ...
    <script>
        layui.use('table', function(){
            ...
            table.render({
                elem: '#list'
                ,url:'{{url("admin/CarBrand/index")}}'
                ,method:'post'
                ,cols: [[
                    {field:'brand_id', width:80, title: 'ID'},

                    {field: 'brand_name',align:'left', title: '名称', width: 300},
                    {field: 'initial',align:'center', title: '首字母', width: 100},
            ...
            table.on('edit(list)', function(obj){
                ...
                $.post('{{url("admin/CarBrand/sort")}}',{id:data.brand_id,sort:value},function(res){
                    if(res.code==1){
            ...
            table.on('tool(list)', function(obj){
                ...
                if(obj.event === 'del'){
                    layer.confirm('确定要删除吗？', function(index){
                        ...
                        $.post('{{url("admin/CarBrand/del")}}',{id:data.brand_id},function(res){
                            layer.close(loading);
                            if(res.code === 1){
                                layer.msg(res.msg, {time: 1000, icon: 1});
                                layer.close(index);
                    ...
                    location.href = "{{url('admin/CarBrand/edit')}}?id="+data.brand_id;
                }
            });
        });
    </script>
