...
@section('content')
	@parent
	<link rel="stylesheet" href="{{ URL::asset(_ADMIN_.'css/index.css') }}" media="all" />
	<script>
		var ADMIN = "{{_ADMIN_.'js/'}}";
		var navs = '{!!$menus!!}';
	</script>
			...
			<div class="layui-main mag0">
				...
				<ul class="layui-nav mobileTopLevelMenus" mobile>
					<li class="layui-nav-item" data-menu="contentManagement">
						<a href="javascript:;"><i class="seraph icon-caidan"></i><cite></cite></a>
				...
				<ul class="layui-nav top_menu">
					<li class="layui-nav-item" pc>
						<a href="javascript:;" name="{{url('admin/login/delCache')}}" class="clearCache"><i class="layui-icon" data-icon="&#xe640;">&#xe640;</i><cite>清除缓存</cite><!--<span class="layui-badge-dot"></span>--></a>
					</li>
					<!--<li class="layui-nav-item lockcms" pc>-->
					<!--<a href="javascript:;"><i class="seraph icon-lock"></i><cite>锁屏</cite></a>-->
					<!--</li>-->
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="{{Session::get('avatar')}}" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">{{Session::get('username')}}</cite></a>
						<dl class="layui-nav-child">
							...
							<dd><a href="{{url('admin/login/index')}}" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
...
@section('js')
	@parent
<script type="text/javascript" src="{{ URL::asset(_ADMIN_.'js/index.js') }}"></script>
